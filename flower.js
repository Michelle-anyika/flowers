...
function drawPetal(rotation) {
  ...
  ctx.bezierCurveTo(-60, -40, -120, -200, -70, -380);
  ctx.bezierCurveTo(-20, -450, 20, -450, 70, -380);
  ctx.bezierCurveTo(120, -200, 60, -40, 0, 0);
...
function drawFlower() {
  ...
  // petals (depth: back to front)
  for (let i = 0; i < 7; i++) {
    drawPetal((i / 7) * Math.PI * 2 + 0.15);
  }
  ...
  // water droplets (manually placed like your image)
  const droplets = [
